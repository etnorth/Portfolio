...
class PIDAutotune(object):
    ...
    def set_initial_output(self, val):
        self._initial_output = val
    ...
    def run(self, input_val):
        ...
        if (self._state == PIDAutotune.STATE_RELAY_STEP_UP
            ...
            print('switched state: {0}'.format(self._state))
            print('input: {0}'.format(input_val))
        ...
        if inflection:
            ...
            print('found peak: {0}'.format(input_val))
            print('peak count: {0}'.format(self._peak_count))
        ...
        if inflection and (self._peak_count > 4):
            ...
            print('amplitude: {0}'.format(self._induced_amplitude))
            print('amplitude deviation: {0}'.format(amplitude_dev))
